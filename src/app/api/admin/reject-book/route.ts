/**
 * Legacy reject-book GET endpoint — READ ONLY.
 *
...
export async function GET(request: NextRequest) {
  ...
  if (!bookId) {
    return html(
      `<h1>Rejection links have moved</h1>
       <p>Book rejections now happen on the secure review page, which the reviewer
  ...
  return html(
    `<h1>Action required on the review page</h1>
     ...
     <p>To reject or approve it, open the secure review link that was sent in
     the notification email. That page lets you read the story, identify
     problem pages, and submit your decision.</p>
     <p><a href="${adminBooksUrl}">Go to the admin book list</a></p>
